module SpreeBloggingSpree
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        inject_into_file 'app/assets/stylesheets/store/all.css', " *= require store/spree_blogging_spree\n", :before => /\*\//, :verbose => true
        inject_into_file 'app/assets/stylesheets/admin/all.css', " *= require admin/spree_blogging_spree\n", :before => /\*\//, :verbose => true
      end
